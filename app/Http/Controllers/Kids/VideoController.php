...
use App\Models\Cms\Instansivideo;
    ...
    public function store(Request $request)
    {
        ...
        if($validasi->fails()){
            ...
            if($request->has('kode') && $request->input('kode')!=""){
                ...
                $model=Instansivideo::find($kd);
            }else{
                $model=new Instansivideo;
            }

            $instansi=Instansi::first();
            
            $model->instansi_id=$instansi->id;
            $model->youtube_url=$request->input('url');
