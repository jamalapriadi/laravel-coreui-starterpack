                                ...
                                <div class="img-box-s2">
                                    ...
                                    <div class="outer-box">
                                        <div class="content">
                                            ...
                                            <div class="date"><span class="icon-clock">{{date('d M Y',strtotime($page->tanggal))}} | {{$page->jam_mulai}} - {{$page->jam_selesai}}</span> <span class="icon-location">{{$page->lokasi}}</span></div>
                                            {!! $page->description !!}
                                        </div>
                                    </div>
                                </div>
