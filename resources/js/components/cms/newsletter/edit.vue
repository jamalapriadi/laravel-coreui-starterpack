        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-flat">
                    <div class="card-header">Edit Newsletter</div>
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" id="attachment" ref="attachment" class="form-control" v-on:change="handleFileUpload">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                <div class="card card-flat">
                    <div class="card-body">
                        ...
                        <router-link to="/newsletter" class="btn btn-default">
...
export default {
    ...
    methods:{
            ...
            axios.get('data/post/'+id)
                .then(response => {
                    ...
                    if(response.data.featured_image!=null){
                        this.state.tmp_file='/uploads/newsletter/'+response.data.featured_image;
        ...
        handleFileUpload(e){
            ...
            if(ukuran > 2000000){
                this.$swal('Warning', 'Ukuran File tidak boleh lebih dari 2 MB' , 'warning');
                return;
            }
        ...
        createFile(file) {
            ...
            let vm = this;
            reader.onload = (e) => {
                vm.state.attachment = e.target.result;
            };
            reader.readAsDataURL(file);
        },
