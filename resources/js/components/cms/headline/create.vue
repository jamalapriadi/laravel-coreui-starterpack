<template>
    <form @submit.prevent="store" action="data/headline" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-flat">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="topik" id="topik" placeholder="Topik" v-model="state.topik">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="card card-flat">
                    <div class="card-body">
                        ...
                        <router-link to="/headline" class="btn btn-default">
