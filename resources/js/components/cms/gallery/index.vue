                        ...
                        <div class="card-body">
                            <form @submit.prevent="savegallery" action="data/save-file-gallery" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card card-default" v-show="showPreview">
                                    ...
                                    <div class="card-body">
                                        <img v-bind:src="form.preview_file" class="img-fluid" v-bind:style="{ 'height': form.height+'px', 'width': form.width+'px', 'border-top-left-radius': form.border_radius.top_left+'px', 'border-top-right-radius': form.border_radius.top_right+'px', 'border-bottom-left-radius': form.border_radius.bottom_left+'px', 'border-bottom-right-radius': form.border_radius.bottom_right+'px'}">
                                                ...
                                                <fieldset>
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" v-model="form.width">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="number" class="form-control" v-model="form.height">
                                                            <span class="input-group-append">
                                                                <button class="btn btn-secondary" type="button">px</button>
                                                            </span>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" v-model="form.border_radius.top_left">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" v-model="form.border_radius.top_right">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" v-model="form.border_radius.bottom_left">
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-lg-6">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input type="text" class="form-control" v-model="form.border_radius.bottom_right">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="alignment" id="alignment" v-model="form.alignment" class="form-control">
