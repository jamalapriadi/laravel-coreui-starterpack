<template>
    <form @submit.prevent="store" action="data/program" method="post" enctype="multipart/form-data">
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-flat">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="lasttitle" id="lasttitle" placeholder="Sub Title" v-model="state.second_title">
                        </div>
                        <div class="form-group">
            ...
            <div class="col-lg-12">
                <div class="card card-flat">
                    <div class="card-body">
                        ...
                        <router-link to="/our-program" class="btn btn-default">
