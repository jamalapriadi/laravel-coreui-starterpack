    ...
    <div class="card card-accent-primary">
        <div class="card-header">
            ...
            <div class="card-header-actions">
                <router-link to="/founder/create" class="btn btn-primary">
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(l, index) in list.data" v-bind:key="index">
                            ...
                            <td>
                                <div class="btn-group">
                                    <router-link :to="{ name: 'founder-view', params: {id: l.id}}" class="btn btn-warning">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/founder?page='+page+'&halaman='+this.halaman)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('data/founder?q='+this.pencarian+'&page='+page+'&halaman='+this.halaman)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
