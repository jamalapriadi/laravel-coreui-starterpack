                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        <tr v-for="(l, index) in list.data" v-bind:key="index">
                            ...
                            <td>
                                <div class="btn-group">
                                    <router-link :to="{ name: 'role-detail', params: {id: l.id}}" class="btn btn-success" title="Role">
                                        <i class="icon-support text-white"></i>
                                    </router-link>
                                    
                                    <router-link :to="{ name: 'role-view', params: {id: l.id}}" class="btn btn-warning" title="Edit">
                                        <i class="fa fa-edit text-white"></i>
                                    </router-link>


                                    <a class="btn btn-danger" v-on:click="hapus(l.id, index, l.nm)" v-bind:id="'delete'+l.id" title="Hapus">
    ...
    export default {
        ...
        methods: {
            ...
            showData(page){
                ...
                axios.get('data/roles?page='+page+'&halaman='+this.halaman)
                    .then(response => {
                        this.loading=false;
                        this.list = response.data;
            ...
            cariData(page){
                ...
                axios.get('data/roles?q='+this.pencarian+'&halaman='+this.halaman)
                    .then(response => {
                        this.list = response.data;
                    })
                    .catch( errors => {
